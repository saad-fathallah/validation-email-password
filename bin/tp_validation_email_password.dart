      ...
      case "2":
        {
          ...
          stdout.write("Entrez votre mot de passe : ");
          String password = stdin.readLineSync()!;
          int userIndex = RecherchUser(email);
      ...
      case "4":
        {
          ...
          if (checkPassword(newPassword)) {
            UpdatModePass(email, newPassword);
          } else {
...
void UpdatModePass(String email, String newPassword) {
  int userIndex = RecherchUser(email);
  if (userIndex != -1) {
...
void SuprimAcount(String email) {
  int userIndex = RecherchUser(email);
  if (userIndex != -1) {
